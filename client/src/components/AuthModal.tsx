                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-8">
                        <button
                            ...
                            className="w-full bg-primary hover:bg-primary-container text-white py-3.5 px-4 text-xs font-medium tracking-widest uppercase hover:text-secondary focus:outline-none transition-colors disabled:opacity-75 cursor-pointer"
                        >
